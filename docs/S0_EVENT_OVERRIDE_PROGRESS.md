...
- [x] 新币开盘尾部结构家族回测（105 个 2024+ 新上市，10 结构 × 0/1/2% 滑点 × 0.24/0.60 成本）：**open_s15_tp50 / open_s20_tp50 首次通过分年+去头部双门槛**（2025 PF 1.33-1.73、去头部 1.26-1.60、bootstrap 99%）；账户 1x 全仓 10U→16.3x/2.5年，Kelly 仓位反而爆仓；前向影子将实测真实滑点（`docs/s0-new-listing-open-tail-candidate-2026-08-05.md`）
