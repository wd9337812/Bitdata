...
当前版本 `v0.9.3`：V4 风险恢复只使用当前版本真正参与排名决策的 `decision` 影子证据；用于研究漏判的 `exploration` 影子仍完整留档，但不再污染恢复 PF。实盘策略仍是 `extreme_v4_roll@v4.0`，本次没有修改排序、仓位、杠杆或保护单。详见 [v0.9.3 V4 决策影子证据口径留档](docs/v0.9.3-v4-decision-shadow-scope-2026-07-17.md)。
