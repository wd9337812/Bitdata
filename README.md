...
当前版本 `v0.6.0`：S0-S2 使用 V3.2 机会引擎。逆市场方向、恐慌追空、过度延伸和中周期不一致不再进入实盘；A+ 只有在当前版本的实盘与影子证据都达标后才允许放大。严重实盘恶化或权益高点回撤会独立停止新仓，影子结果和高分候选不能绕过。实盘换仓默认关闭，5U 硬停止与交易所止盈止损保护保持不变。详见 [v0.6.0 留档](docs/v0.6.0-v32-evidence-guard-2026-07-13.md)。
