...
当前应用版本 `v0.31.3`。S0 阶段的主路线是 **30 日山寨动量**：每天 UTC 窗口在至少 60 个高流动性永续币中，选择与 BTC 及山寨市场广度同向的最强/最弱端，按 20% 计划风险起步、2 倍杠杆、90% 保证金入场；权益达到 30U 后自动升到 22% 风险档。3 ATR 止损、3R 止盈、最长持有 7 天。只有当天没有可执行的山寨候选时才检查 BNB `28/56 日市场趋势共振` 后备。交易所止盈止损、5U 硬停止、0.5U 额外预留、裸仓修复和 API 限频保持不变。完整设计见 `docs/v0.31.0-s0-altcoin-30d-primary-2026-08-03.md`、`docs/v0.31.2-s0-altcoin-30d-risk20-promotion-2026-08-04.md`、`docs/v0.31.3-s0-altcoin-30d-risk-tier-2026-08-04.md` 与 `docs/s0-market-tsmom-executable-v3-audit-2026-08-03.md`。
