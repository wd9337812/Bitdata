...
当前版本 `v0.4.0`：S0-S2 升级为机会引擎 V3，使用全市场横截面、趋势结构、量价、衍生品、流动性和真实成本统一筛选 A+/A/B 机会；V3 信用与旧 V2 隔离，影子交易改为 WebSocket 驱动，并加入分级恢复。5U 硬停止与持仓止盈止损保护保持不变。详见 [机会引擎 V3 留档](docs/opportunity-engine-v3-2026-07-12.md)。
