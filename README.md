...
当前应用版本 `v0.30.3`。S0 可由 `28/56 日市场趋势共振 V3` 接管：每天用高流动性永续币构造市场指数，快慢趋势同时向上时做多；BTC 为首选合约，小账户因 BTC 最小合约无法守住风险预算时才回退 ETH。仓位按交易所数量步长、最小名义价值和真实 ATR 止损距离预演，采用 ATR(10) 三倍移动止损、15% 灾难止损和 20 天持仓上限。交易所止盈止损、5U 硬停止、裸仓修复和 API 限频保持不变。完整审计见 `docs/s0-market-tsmom-executable-v3-audit-2026-08-03.md`。
