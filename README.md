...
当前版本 `v0.5.0`：V3 继续负责 S0-S2 实盘，V3.1 作为中周期影子挑战者，与主策略共享行情、盘口、成本和衍生品数据；挑战者达到独立样本门槛前不会接管实盘。升级后新开的 V3 仓位支持“新止损确认后再撤旧止损”的保本与 ATR 移动止盈。Dashboard 收敛为控制台、机会中心、交易复盘、设置和系统五个入口，10 秒刷新只读取本地聚合快照。5U 硬停止与交易所止盈止损保护保持不变。详见 [v0.5.0 留档](docs/v0.5.0-v31-dashboard-2026-07-13.md)。
