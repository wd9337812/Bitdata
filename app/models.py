...
class TradingConfig(BaseModel):
    ...
    yolo_scalp_orderbook_min_imbalance: float = Field(default=0.08, ge=0, le=1)
    yolo_scalp_orderbook_strong_imbalance: float = Field(default=0.18, ge=0, le=1)
    ...
    yolo_scalp_orderbook_min_profit_cost_ratio: float = Field(default=1.15, ge=0, le=100)
    yolo_scalp_orderbook_min_net_profit_pct: float = Field(default=0.04, ge=0, le=20)
