...
class TradingConfig(BaseModel):
    ...
    opportunity_v4_strategy_version: str = "v4.6.1"
    ...
    opportunity_v44_max_hold_bars: int = Field(default=6, ge=1, le=200)
    ...
    strategy_canary_release_id: str = "extreme_v4_roll@v4.6.1"
