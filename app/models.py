...
class TradingConfig(BaseModel):
    ...
    live_credit_strong_score: float = Field(default=80.0, ge=0, le=100)
    live_credit_normal_score: float = Field(default=65.0, ge=0, le=100)
    live_credit_observe_score: float = Field(default=45.0, ge=0, le=100)
    live_credit_penalty_score: float = Field(default=30.0, ge=0, le=100)
    live_credit_max_risk_multiplier: float = Field(default=1.15, ge=0.1, le=2)
    live_credit_observe_risk_multiplier: float = Field(default=0.70, ge=0.05, le=1)
    live_credit_weak_risk_multiplier: float = Field(default=0.45, ge=0.05, le=1)
    live_credit_penalty_observe_only: bool = True
