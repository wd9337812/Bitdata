...
def strategy_supports(value: Any, capability: str) -> bool:
    ...
    if raw_version.startswith("v5."):
        ...
        if raw_version.startswith(("v5.1", "v5.2", "v5.3", "v5.4", "v5.5")):
            supported.update(
                {
