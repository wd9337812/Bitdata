...
HISTORICAL_DIRECTION_SEED = {
    "LONG": [-15.6, 4.067689, -15.6, 4.578635, 44.4, 44.4, -15.6, 17.38463],
    "SHORT": [-15.6, -15.6, -15.6, 21.674979, -15.6, 22.97971, -15.6, 44.4],
}
    ...
    *,
    ...
    if closed_net_pcts is None:
        ...
        try:
            ...
            closed_net_pcts = []
    seed = list(HISTORICAL_DIRECTION_SEED.get(normalized, []))
    outcomes = (seed + [float(value) for value in closed_net_pcts])[-window:]
