...
def update_release_equity_guard(
    ...
    *,
    ...
    threshold = float(
        ...
        if version.startswith(("v4.4", "v4.5", "v4.6", "v4.7"))
        ...
        with connect() as conn:
            ...
            try:
                ...
                scoped_shadow = filter_live_eligible_v4_shadows(
                    ...
                    allow_unclassified_legacy=not current_version.startswith(("v4.3", "v4.4", "v4.5", "v4.6", "v4.7")),
                )
                if current_version.startswith(("v4.5", "v4.6", "v4.7")):
